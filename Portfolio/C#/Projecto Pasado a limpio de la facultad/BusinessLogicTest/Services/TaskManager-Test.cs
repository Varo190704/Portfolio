...
public class TaskManager_Test
{
    ...
    public void AssResource_and_DeleteResource_behave_correctly()
    {
        ...
        var r = new Resource("R", TaskType.Human, "D");
        repo.Add(t);
        mgr.AssResource(t, r);
    ...
    public void AlwaysUpdateTasks_filters_resources_and_updates_repo()
    {
        ...
        repo.Add(task);
        var r1 = new Resource("R1", TaskType.Software, "Old");
        var r2 = new Resource("R2", TaskType.Human, "Old2");
        task.Resources.Add(r1);
        task.Resources.Add(r2);
        var updatedResources = new List<Resource> { new Resource("T", TaskType.Infrastructure, "New") };
