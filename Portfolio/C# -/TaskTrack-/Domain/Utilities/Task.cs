...
public class Task
{
    ...
    public Task(string name, string description, int duration, int slak, DateOnly startDate, DateOnly endDate, TaskProgress statusR, DateOnly lateStartDate, DateOnly lateEndDate)
    {
        Name = name;
        Description = description;
        Duration = duration;
