 ...
 * @author varo1
 */
public class noNum extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("El dato ingresado no es un número.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(noNum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
