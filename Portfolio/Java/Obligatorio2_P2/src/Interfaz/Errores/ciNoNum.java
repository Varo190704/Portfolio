 ...
 * @author varo1
 */
public class ciNoNum extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("E.l valor ingresado de la cédula tiene que ser numérico.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ciNoNum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
